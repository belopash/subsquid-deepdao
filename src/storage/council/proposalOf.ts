...
async function getInstanceStorageData(
    ...
    return await ctx._chain.getStorage(ctx.block.hash, 'Instance1Collective', 'ProposalOf', hash)
...
async function getCoucilStorageData(
    ...
    return await ctx._chain.getStorage(ctx.block.hash, 'Council', 'ProposalOf', hash)
