...
export type Type_148 = Type_148_System | Type_148_ParachainSystem | Type_148_Timestamp | Type_148_Balances | Type_148_ParachainStaking | Type_148_AuthorInherent | Type_148_AuthorFilter | Type_148_AuthorMapping | Type_148_Utility | Type_148_Proxy | Type_148_MaintenanceMode | Type_148_Identity | Type_148_EVM | Type_148_Ethereum | Type_148_Scheduler | Type_148_Democracy | Type_148_CouncilCollective | Type_148_TechComitteeCollective | Type_148_Treasury | Type_148_CrowdloanRewards

export interface Type_148_System {
  __kind: 'System'
  value: SystemCall
}

export interface Type_148_ParachainSystem {
  __kind: 'ParachainSystem'
  value: ParachainSystemCall
}

export interface Type_148_Timestamp {
  __kind: 'Timestamp'
  value: TimestampCall
}

export interface Type_148_Balances {
  __kind: 'Balances'
  value: BalancesCall
}

export interface Type_148_ParachainStaking {
  __kind: 'ParachainStaking'
  value: ParachainStakingCall
}

export interface Type_148_AuthorInherent {
  __kind: 'AuthorInherent'
  value: AuthorInherentCall
}

export interface Type_148_AuthorFilter {
  __kind: 'AuthorFilter'
  value: AuthorFilterCall
}

export interface Type_148_AuthorMapping {
  __kind: 'AuthorMapping'
  value: AuthorMappingCall
}

export interface Type_148_Utility {
  __kind: 'Utility'
  value: UtilityCall
}

export interface Type_148_Proxy {
  __kind: 'Proxy'
  value: ProxyCall
}

export interface Type_148_MaintenanceMode {
  __kind: 'MaintenanceMode'
  value: MaintenanceModeCall
}

export interface Type_148_Identity {
  __kind: 'Identity'
  value: IdentityCall
}

export interface Type_148_EVM {
  __kind: 'EVM'
  value: EVMCall
}

export interface Type_148_Ethereum {
  __kind: 'Ethereum'
  value: EthereumCall
}

export interface Type_148_Scheduler {
  __kind: 'Scheduler'
  value: SchedulerCall
}

export interface Type_148_Democracy {
  __kind: 'Democracy'
  value: DemocracyCall
}

export interface Type_148_CouncilCollective {
  __kind: 'CouncilCollective'
  value: CouncilCollectiveCall
}

export interface Type_148_TechComitteeCollective {
  __kind: 'TechComitteeCollective'
  value: TechComitteeCollectiveCall
}

export interface Type_148_Treasury {
  __kind: 'Treasury'
  value: TreasuryCall
}

export interface Type_148_CrowdloanRewards {
...
export type Type_62 = Type_62_System | Type_62_ParachainSystem | Type_62_Timestamp | Type_62_Balances | Type_62_ParachainStaking | Type_62_AuthorInherent | Type_62_AuthorFilter | Type_62_AuthorMapping | Type_62_Utility | Type_62_Proxy | Type_62_MaintenanceMode | Type_62_Identity | Type_62_EVM | Type_62_Ethereum | Type_62_Scheduler | Type_62_Democracy | Type_62_CouncilCollective | Type_62_TechComitteeCollective | Type_62_Treasury | Type_62_CrowdloanRewards

export interface Type_62_System {
  __kind: 'System'
  value: SystemCall
}

export interface Type_62_ParachainSystem {
  __kind: 'ParachainSystem'
  value: ParachainSystemCall
}

export interface Type_62_Timestamp {
  __kind: 'Timestamp'
  value: TimestampCall
}

export interface Type_62_Balances {
  __kind: 'Balances'
  value: BalancesCall
}

export interface Type_62_ParachainStaking {
  __kind: 'ParachainStaking'
  value: ParachainStakingCall
}

export interface Type_62_AuthorInherent {
  __kind: 'AuthorInherent'
  value: AuthorInherentCall
}

export interface Type_62_AuthorFilter {
  __kind: 'AuthorFilter'
  value: AuthorFilterCall
}

export interface Type_62_AuthorMapping {
  __kind: 'AuthorMapping'
  value: AuthorMappingCall
}

export interface Type_62_Utility {
  __kind: 'Utility'
  value: UtilityCall
}

export interface Type_62_Proxy {
  __kind: 'Proxy'
  value: ProxyCall
}

export interface Type_62_MaintenanceMode {
  __kind: 'MaintenanceMode'
  value: MaintenanceModeCall
}

export interface Type_62_Identity {
  __kind: 'Identity'
  value: IdentityCall
}

export interface Type_62_EVM {
  __kind: 'EVM'
  value: EVMCall
}

export interface Type_62_Ethereum {
  __kind: 'Ethereum'
  value: EthereumCall
}

export interface Type_62_Scheduler {
  __kind: 'Scheduler'
  value: SchedulerCall
}

export interface Type_62_Democracy {
  __kind: 'Democracy'
  value: DemocracyCall
}

export interface Type_62_CouncilCollective {
  __kind: 'CouncilCollective'
  value: CouncilCollectiveCall
}

export interface Type_62_TechComitteeCollective {
  __kind: 'TechComitteeCollective'
  value: TechComitteeCollectiveCall
}

export interface Type_62_Treasury {
  __kind: 'Treasury'
  value: TreasuryCall
}

export interface Type_62_CrowdloanRewards {
  __kind: 'CrowdloanRewards'
  value: CrowdloanRewardsCall
}
