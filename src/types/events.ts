...
export class BountiesBountyAwardedEvent {
  ...
  get asLatest(): {index: number, beneficiary: v2010.AccountId32} {
    deprecateLatest()
    return this.asV2010
  }
}
...
export class BountiesBountyClaimedEvent {
  ...
  get asLatest(): {index: number, payout: bigint, beneficiary: v2010.AccountId32} {
    deprecateLatest()
    return this.asV2010
  }
}
...
export class DemocracyExecutedEvent {
   ...
   *  A proposal has been enacted. \[ref_index, result\]
   */
  get asV1009(): [number, Result<null, v1009.DispatchError>] {
    assert(this.isV1009)
    return this.ctx._chain.decodeEvent(this.ctx.event)
  }
...
export class DemocracyPreimageInvalidEvent {
  ...
  get asLatest(): {proposalHash: v2010.H256, refIndex: number} {
    deprecateLatest()
    return this.asV2010
  }
}
...
export class DemocracyPreimageNotedEvent {
  ...
  get asLatest(): {proposalHash: v2010.H256, who: v2010.AccountId32, deposit: bigint} {
    deprecateLatest()
    return this.asV2010
  }
}
...
export class DemocracyPreimageReapedEvent {
  ...
  get asLatest(): {proposalHash: v2010.H256, provider: v2010.AccountId32, deposit: bigint, reaper: v2010.AccountId32} {
    deprecateLatest()
    return this.asV2010
  }
}
...
export class DemocracyPreimageUsedEvent {
  ...
  get asLatest(): {proposalHash: v2010.H256, provider: v2010.AccountId32, deposit: bigint} {
    deprecateLatest()
    return this.asV2010
  }
}
...
export class DemocracyStartedEvent {
  ...
  get asLatest(): {refIndex: number, threshold: v2010.VoteThreshold} {
    deprecateLatest()
    return this.asV2010
  }
}
...
export class DemocracyTabledEvent {
  ...
  get asLatest(): {proposalIndex: number, deposit: bigint, depositors: v2010.AccountId32[]} {
    deprecateLatest()
    return this.asV2010
  }
}
...
export class GeneralCouncilApprovedEvent {
  ...
  get asLatest(): {proposalHash: v2010.H256} {
    deprecateLatest()
    return this.asV2010
  }
}
...
export class GeneralCouncilClosedEvent {
  ...
  get asLatest(): {proposalHash: v2010.H256, yes: number, no: number} {
    deprecateLatest()
    return this.asV2010
  }
}
...
export class GeneralCouncilExecutedEvent {
   ...
   */
  get isV1000(): boolean {
    return this.ctx._chain.getEventHash('generalCouncil.Executed') === 'f98b87482f886396f52d6875083e9b201ac0e3f97d718c37613afad51e85a9b7'
  }
   ...
   *  \[proposal_hash, result\]
   */
  get asV1000(): [Uint8Array, Result<null, v1000.DispatchError>] {
    assert(this.isV1000)
    return this.ctx._chain.decodeEvent(this.ctx.event)
  }
...
export class GeneralCouncilProposedEvent {
  ...
  get asLatest(): {account: v2010.AccountId32, proposalIndex: number, proposalHash: v2010.H256, threshold: number} {
    deprecateLatest()
    return this.asV2010
  }
}
...
export class GeneralCouncilVotedEvent {
  ...
  get asLatest(): {account: v2010.AccountId32, proposalHash: v2010.H256, voted: boolean, yes: number, no: number} {
    deprecateLatest()
    return this.asV2010
  }
}
...
export class TipsNewTipEvent {
  ...
  get asLatest(): {tipHash: v2010.H256} {
    deprecateLatest()
    return this.asV2010
  }
}
...
export class TipsTipClosedEvent {
  ...
  get asLatest(): {tipHash: v2010.H256, who: v2010.AccountId32, payout: bigint} {
    deprecateLatest()
    return this.asV2010
  }
}
...
export class TipsTipSlashedEvent {
  ...
  get asLatest(): {tipHash: v2010.H256, finder: v2010.AccountId32, deposit: bigint} {
    deprecateLatest()
    return this.asV2010
  }
}
