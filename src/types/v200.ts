...
export type Type_103 = Type_103_System | Type_103_ParachainSystem | Type_103_Timestamp | Type_103_Balances | Type_103_ParachainStaking | Type_103_AuthorInherent | Type_103_AuthorFilter | Type_103_AuthorMapping | Type_103_Utility | Type_103_Proxy | Type_103_EVM | Type_103_Ethereum | Type_103_Scheduler | Type_103_Democracy | Type_103_CouncilCollective | Type_103_TechComitteeCollective | Type_103_Treasury | Type_103_CrowdloanRewards
...
export interface Type_103_ParachainSystem {
...
export interface Type_103_ParachainStaking {
  __kind: 'ParachainStaking'
  value: ParachainStakingCall
}

export interface Type_103_AuthorInherent {
  __kind: 'AuthorInherent'
  value: AuthorInherentCall
}

export interface Type_103_AuthorFilter {
  __kind: 'AuthorFilter'
  value: AuthorFilterCall
}

export interface Type_103_AuthorMapping {
...
export interface Type_103_Proxy {
  __kind: 'Proxy'
  value: ProxyCall
}

export interface Type_103_EVM {
  __kind: 'EVM'
  value: EVMCall
}

export interface Type_103_Ethereum {
  __kind: 'Ethereum'
  value: EthereumCall
}
...
export interface Type_103_CouncilCollective {
  __kind: 'CouncilCollective'
  value: CouncilCollectiveCall
}

export interface Type_103_TechComitteeCollective {
...
export interface Type_103_CrowdloanRewards {
