...
export type Type_106 = Type_106_System | Type_106_ParachainSystem | Type_106_Timestamp | Type_106_Balances | Type_106_ParachainStaking | Type_106_AuthorInherent | Type_106_AuthorFilter | Type_106_AuthorMapping | Type_106_Utility | Type_106_Proxy | Type_106_MaintenanceMode | Type_106_EVM | Type_106_Ethereum | Type_106_Scheduler | Type_106_Democracy | Type_106_CouncilCollective | Type_106_TechComitteeCollective | Type_106_Treasury | Type_106_CrowdloanRewards
...
export interface Type_106_MaintenanceMode {
...
export type Type_64 = Type_64_System | Type_64_ParachainSystem | Type_64_Timestamp | Type_64_Balances | Type_64_ParachainStaking | Type_64_AuthorInherent | Type_64_AuthorFilter | Type_64_AuthorMapping | Type_64_Utility | Type_64_Proxy | Type_64_MaintenanceMode | Type_64_EVM | Type_64_Ethereum | Type_64_Scheduler | Type_64_Democracy | Type_64_CouncilCollective | Type_64_TechComitteeCollective | Type_64_Treasury | Type_64_CrowdloanRewards
...
export interface Type_64_AuthorFilter {
  __kind: 'AuthorFilter'
  value: AuthorFilterCall
}
...
export interface Type_64_Proxy {
  __kind: 'Proxy'
  value: ProxyCall
}

export interface Type_64_MaintenanceMode {
  __kind: 'MaintenanceMode'
  value: MaintenanceModeCall
}

export interface Type_64_EVM {
  __kind: 'EVM'
  value: EVMCall
}

export interface Type_64_Ethereum {
  __kind: 'Ethereum'
  value: EthereumCall
}

export interface Type_64_Scheduler {
  __kind: 'Scheduler'
  value: SchedulerCall
}

export interface Type_64_Democracy {
  __kind: 'Democracy'
  value: DemocracyCall
}

export interface Type_64_CouncilCollective {
  __kind: 'CouncilCollective'
  value: CouncilCollectiveCall
}

export interface Type_64_TechComitteeCollective {
  __kind: 'TechComitteeCollective'
  value: TechComitteeCollectiveCall
}
...
export interface Type_64_CrowdloanRewards {
  __kind: 'CrowdloanRewards'
  value: CrowdloanRewardsCall
}
