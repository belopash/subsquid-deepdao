...
export type Type_107 = Type_107_System | Type_107_Timestamp | Type_107_Indices | Type_107_Sudo | Type_107_ParachainSystem | Type_107_Balances | Type_107_Authorship | Type_107_CollatorSelection | Type_107_Session | Type_107_Democracy | Type_107_Council | Type_107_TechnicalCommittee | Type_107_PhragmenElection | Type_107_CouncilMembership | Type_107_TechnicalMembership | Type_107_XcmpQueue | Type_107_PolkadotXcm | Type_107_CumulusXcm | Type_107_DmpQueue | Type_107_Utility | Type_107_Scheduler | Type_107_Multisig | Type_107_Vesting | Type_107_Treasury | Type_107_Bounties | Type_107_Tips | Type_107_XTokens | Type_107_Tokens | Type_107_Currencies | Type_107_FlexibleFee

export interface Type_107_System {
  __kind: 'System'
  value: SystemCall
}

export interface Type_107_Timestamp {
  __kind: 'Timestamp'
  value: TimestampCall
}

export interface Type_107_Indices {
  __kind: 'Indices'
  value: IndicesCall
}

export interface Type_107_Sudo {
  __kind: 'Sudo'
  value: SudoCall
}

export interface Type_107_ParachainSystem {
  __kind: 'ParachainSystem'
  value: ParachainSystemCall
}

export interface Type_107_Balances {
  __kind: 'Balances'
  value: BalancesCall
}

export interface Type_107_Authorship {
  __kind: 'Authorship'
  value: AuthorshipCall
}

export interface Type_107_CollatorSelection {
  __kind: 'CollatorSelection'
  value: CollatorSelectionCall
}

export interface Type_107_Session {
  __kind: 'Session'
  value: SessionCall
}

export interface Type_107_Democracy {
  __kind: 'Democracy'
  value: DemocracyCall
}

export interface Type_107_Council {
  __kind: 'Council'
  value: CouncilCall
}

export interface Type_107_TechnicalCommittee {
  __kind: 'TechnicalCommittee'
  value: TechnicalCommitteeCall
}

export interface Type_107_PhragmenElection {
  __kind: 'PhragmenElection'
  value: PhragmenElectionCall
}

export interface Type_107_CouncilMembership {
  __kind: 'CouncilMembership'
  value: CouncilMembershipCall
}

export interface Type_107_TechnicalMembership {
  __kind: 'TechnicalMembership'
  value: TechnicalMembershipCall
}

export interface Type_107_XcmpQueue {
  __kind: 'XcmpQueue'
  value: XcmpQueueCall
}

export interface Type_107_PolkadotXcm {
  __kind: 'PolkadotXcm'
  value: PolkadotXcmCall
}

export interface Type_107_CumulusXcm {
  __kind: 'CumulusXcm'
  value: CumulusXcmCall
}

export interface Type_107_DmpQueue {
  __kind: 'DmpQueue'
  value: DmpQueueCall
}

export interface Type_107_Utility {
  __kind: 'Utility'
  value: UtilityCall
}

export interface Type_107_Scheduler {
  __kind: 'Scheduler'
  value: SchedulerCall
}

export interface Type_107_Multisig {
  __kind: 'Multisig'
  value: MultisigCall
}

export interface Type_107_Vesting {
  __kind: 'Vesting'
  value: VestingCall
}

export interface Type_107_Treasury {
  __kind: 'Treasury'
  value: TreasuryCall
}

export interface Type_107_Bounties {
  __kind: 'Bounties'
  value: BountiesCall
}

export interface Type_107_Tips {
  __kind: 'Tips'
  value: TipsCall
}

export interface Type_107_XTokens {
  __kind: 'XTokens'
  value: XTokensCall
}

export interface Type_107_Tokens {
  __kind: 'Tokens'
  value: TokensCall
}

export interface Type_107_Currencies {
  __kind: 'Currencies'
  value: CurrenciesCall
}

export interface Type_107_FlexibleFee {
  __kind: 'FlexibleFee'
...
export type Type_27 = Type_27_System | Type_27_Timestamp | Type_27_Indices | Type_27_Sudo | Type_27_ParachainSystem | Type_27_Balances | Type_27_Authorship | Type_27_CollatorSelection | Type_27_Session | Type_27_Democracy | Type_27_Council | Type_27_TechnicalCommittee | Type_27_PhragmenElection | Type_27_CouncilMembership | Type_27_TechnicalMembership | Type_27_XcmpQueue | Type_27_PolkadotXcm | Type_27_CumulusXcm | Type_27_DmpQueue | Type_27_Utility | Type_27_Scheduler | Type_27_Multisig | Type_27_Vesting | Type_27_Treasury | Type_27_Bounties | Type_27_Tips | Type_27_XTokens | Type_27_Tokens | Type_27_Currencies | Type_27_FlexibleFee

export interface Type_27_System {
  __kind: 'System'
  value: SystemCall
}

export interface Type_27_Timestamp {
  __kind: 'Timestamp'
  value: TimestampCall
}

export interface Type_27_Indices {
  __kind: 'Indices'
  value: IndicesCall
}

export interface Type_27_Sudo {
  __kind: 'Sudo'
  value: SudoCall
}

export interface Type_27_ParachainSystem {
  __kind: 'ParachainSystem'
  value: ParachainSystemCall
}

export interface Type_27_Balances {
  __kind: 'Balances'
  value: BalancesCall
}

export interface Type_27_Authorship {
  __kind: 'Authorship'
  value: AuthorshipCall
}

export interface Type_27_CollatorSelection {
  __kind: 'CollatorSelection'
  value: CollatorSelectionCall
}

export interface Type_27_Session {
  __kind: 'Session'
  value: SessionCall
}

export interface Type_27_Democracy {
  __kind: 'Democracy'
  value: DemocracyCall
}

export interface Type_27_Council {
  __kind: 'Council'
  value: CouncilCall
}

export interface Type_27_TechnicalCommittee {
  __kind: 'TechnicalCommittee'
  value: TechnicalCommitteeCall
}

export interface Type_27_PhragmenElection {
  __kind: 'PhragmenElection'
  value: PhragmenElectionCall
}

export interface Type_27_CouncilMembership {
  __kind: 'CouncilMembership'
  value: CouncilMembershipCall
}

export interface Type_27_TechnicalMembership {
  __kind: 'TechnicalMembership'
  value: TechnicalMembershipCall
}

export interface Type_27_XcmpQueue {
  __kind: 'XcmpQueue'
  value: XcmpQueueCall
}

export interface Type_27_PolkadotXcm {
  __kind: 'PolkadotXcm'
  value: PolkadotXcmCall
}

export interface Type_27_CumulusXcm {
  __kind: 'CumulusXcm'
  value: CumulusXcmCall
}

export interface Type_27_DmpQueue {
  __kind: 'DmpQueue'
  value: DmpQueueCall
}

export interface Type_27_Utility {
  __kind: 'Utility'
  value: UtilityCall
}

export interface Type_27_Scheduler {
  __kind: 'Scheduler'
  value: SchedulerCall
}

export interface Type_27_Multisig {
  __kind: 'Multisig'
  value: MultisigCall
}

export interface Type_27_Vesting {
  __kind: 'Vesting'
  value: VestingCall
}

export interface Type_27_Treasury {
  __kind: 'Treasury'
  value: TreasuryCall
}

export interface Type_27_Bounties {
  __kind: 'Bounties'
  value: BountiesCall
}

export interface Type_27_Tips {
  __kind: 'Tips'
  value: TipsCall
}

export interface Type_27_XTokens {
  __kind: 'XTokens'
  value: XTokensCall
}

export interface Type_27_Tokens {
  __kind: 'Tokens'
  value: TokensCall
}

export interface Type_27_Currencies {
  __kind: 'Currencies'
  value: CurrenciesCall
}

export interface Type_27_FlexibleFee {
  __kind: 'FlexibleFee'
  value: FlexibleFeeCall
}
...
export type XcmV0_134 = XcmV0_134_WithdrawAsset | XcmV0_134_ReserveAssetDeposit | XcmV0_134_ReceiveTeleportedAsset | XcmV0_134_QueryResponse | XcmV0_134_TransferAsset | XcmV0_134_TransferReserveAsset | XcmV0_134_Transact | XcmV0_134_HrmpNewChannelOpenRequest | XcmV0_134_HrmpChannelAccepted | XcmV0_134_HrmpChannelClosing | XcmV0_134_RelayedFrom

export interface XcmV0_134_WithdrawAsset {
  __kind: 'WithdrawAsset'
  assets: MultiAssetV0[]
  effects: XcmOrderV0[]
}

export interface XcmV0_134_ReserveAssetDeposit {
  __kind: 'ReserveAssetDeposit'
  assets: MultiAssetV0[]
  effects: XcmOrderV0[]
}

export interface XcmV0_134_ReceiveTeleportedAsset {
  __kind: 'ReceiveTeleportedAsset'
  assets: MultiAssetV0[]
  effects: XcmOrderV0[]
}

export interface XcmV0_134_QueryResponse {
  __kind: 'QueryResponse'
  queryId: bigint
  response: ResponseV0
}

export interface XcmV0_134_TransferAsset {
  __kind: 'TransferAsset'
  assets: MultiAssetV0[]
  dest: MultiLocationV0
}

export interface XcmV0_134_TransferReserveAsset {
...
export interface XcmV0_134_Transact {
  __kind: 'Transact'
...
export interface XcmV0_134_HrmpNewChannelOpenRequest {
...
export interface XcmV0_134_HrmpChannelAccepted {
  __kind: 'HrmpChannelAccepted'
  recipient: number
}

export interface XcmV0_134_HrmpChannelClosing {
...
export interface XcmV0_134_RelayedFrom {
  __kind: 'RelayedFrom'
  who: MultiLocationV0
  message: XcmV0_135
}
...
export type XcmV0_135 = XcmV0_135_WithdrawAsset | XcmV0_135_ReserveAssetDeposit | XcmV0_135_ReceiveTeleportedAsset | XcmV0_135_QueryResponse | XcmV0_135_TransferAsset | XcmV0_135_TransferReserveAsset | XcmV0_135_Transact | XcmV0_135_HrmpNewChannelOpenRequest | XcmV0_135_HrmpChannelAccepted | XcmV0_135_HrmpChannelClosing | XcmV0_135_RelayedFrom

export interface XcmV0_135_WithdrawAsset {
  __kind: 'WithdrawAsset'
  assets: MultiAssetV0[]
  effects: XcmOrderV0[]
}

export interface XcmV0_135_ReserveAssetDeposit {
  __kind: 'ReserveAssetDeposit'
  assets: MultiAssetV0[]
  effects: XcmOrderV0[]
}

export interface XcmV0_135_ReceiveTeleportedAsset {
  __kind: 'ReceiveTeleportedAsset'
  assets: MultiAssetV0[]
  effects: XcmOrderV0[]
}

export interface XcmV0_135_QueryResponse {
  __kind: 'QueryResponse'
  queryId: bigint
  response: ResponseV0
}

export interface XcmV0_135_TransferAsset {
  __kind: 'TransferAsset'
  assets: MultiAssetV0[]
  dest: MultiLocationV0
}

export interface XcmV0_135_TransferReserveAsset {
  __kind: 'TransferReserveAsset'
  assets: MultiAssetV0[]
  dest: MultiLocationV0
  effects: XcmOrderV0[]
...
export interface XcmV0_135_Transact {
  __kind: 'Transact'
  originType: XcmOriginKind
  requireWeightAtMost: bigint
  call: DoubleEncodedCall
...
export interface XcmV0_135_HrmpNewChannelOpenRequest {
  __kind: 'HrmpNewChannelOpenRequest'
  sender: number
  maxMessageSize: number
  maxCapacity: number
...
export interface XcmV0_135_HrmpChannelAccepted {
  __kind: 'HrmpChannelAccepted'
  recipient: number
}

export interface XcmV0_135_HrmpChannelClosing {
  __kind: 'HrmpChannelClosing'
  initiator: number
  sender: number
  recipient: number
...
export interface XcmV0_135_RelayedFrom {
  __kind: 'RelayedFrom'
  who: MultiLocationV0
  message: XcmV0_135
}
