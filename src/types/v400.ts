...
export type Type_104 = Type_104_System | Type_104_ParachainSystem | Type_104_Timestamp | Type_104_Balances | Type_104_ParachainStaking | Type_104_AuthorInherent | Type_104_AuthorFilter | Type_104_AuthorMapping | Type_104_Utility | Type_104_Proxy | Type_104_MaintenanceMode | Type_104_EVM | Type_104_Ethereum | Type_104_Scheduler | Type_104_Democracy | Type_104_CouncilCollective | Type_104_TechComitteeCollective | Type_104_Treasury | Type_104_CrowdloanRewards
...
export interface Type_104_ParachainStaking {
  __kind: 'ParachainStaking'
  value: ParachainStakingCall
}

export interface Type_104_AuthorInherent {
  __kind: 'AuthorInherent'
  value: AuthorInherentCall
}

export interface Type_104_AuthorFilter {
  __kind: 'AuthorFilter'
  value: AuthorFilterCall
}

export interface Type_104_AuthorMapping {
...
export interface Type_104_Proxy {
  __kind: 'Proxy'
  value: ProxyCall
}

export interface Type_104_MaintenanceMode {
  __kind: 'MaintenanceMode'
  value: MaintenanceModeCall
}

export interface Type_104_EVM {
  __kind: 'EVM'
  value: EVMCall
}

export interface Type_104_Ethereum {
  __kind: 'Ethereum'
  value: EthereumCall
}
...
export interface Type_104_CouncilCollective {
  __kind: 'CouncilCollective'
  value: CouncilCollectiveCall
}

export interface Type_104_TechComitteeCollective {
...
export interface Type_104_CrowdloanRewards {
