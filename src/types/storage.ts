...
export class CouncilCollectiveProposalOfStorage {
   ...
   */
  get isV900() {
    return this.ctx._chain.getStorageItemTypeHash('CouncilCollective', 'ProposalOf') === '30d56581e955e0a747e440dc53c3fb3bab066b651da862046e5832ebf1009946'
  }
   ...
   */
  get isV1001() {
    return this.ctx._chain.getStorageItemTypeHash('CouncilCollective', 'ProposalOf') === '865c942056a01b1dd23fb27cb999c2ba92166cdecf033312955cc6d93d809fe3'
  }
   ...
   */
  get isV1101() {
    return this.ctx._chain.getStorageItemTypeHash('CouncilCollective', 'ProposalOf') === '9f9097d7732298fa1b657f6d495d6cc0b4bb70d62f1a6c8197a0998cf2757623'
  }
...
export class DemocracyPreimagesStorage {
   ...
   */
  get isV49() {
    return this.ctx._chain.getStorageItemTypeHash('Democracy', 'Preimages') === '4cfebf1c3ec4cbc591b367aceaef472ee18ccb1d7b4a188ca5284e65390f4835'
  }
   ...
   *  The block number is the block at which it was deposited.
   */
  async getAsV49(key: Uint8Array): Promise<v49.PreimageStatus | undefined> {
    assert(this.isV49)
...
export class DemocracyPublicPropsStorage {
   ...
   *  The public proposals. Unsorted. The second item is the proposal's hash.
   */
  async getAsV49(): Promise<[number, Uint8Array, Uint8Array][]> {
    assert(this.isV49)
...
export class DemocracyReferendumInfoOfStorage {
   ...
   *  TWOX-NOTE: SAFE as indexes are not under an attacker’s control.
   */
  async getAsV49(key: number): Promise<v49.ReferendumInfo | undefined> {
    assert(this.isV49)
...
export class Instance1CollectiveMembersStorage {
   ...
   */
  get isV49() {
    return this.ctx._chain.getStorageItemTypeHash('Instance1Collective', 'Members') === 'd14508def9da76532021b53d553e9048fd079e2e735d2393e6d531e6d1fd29ca'
  }
...
export class Instance1CollectiveProposalOfStorage {
   ...
   */
  get isV49() {
    return this.ctx._chain.getStorageItemTypeHash('Instance1Collective', 'ProposalOf') === 'c2200d55dc010bd1db0de89316bebc8bbe807286cce4a413847783c70617e45f'
  }

  /**
   *  Actual proposal for a given hash, if it's current.
   */
  async getAsV49(key: Uint8Array): Promise<v49.Type_105 | undefined> {
    assert(this.isV49)
   ...
   */
  get isV53() {
    return this.ctx._chain.getStorageItemTypeHash('Instance1Collective', 'ProposalOf') === '33a59e33fccb1519e3a6069b550bff656c5271028bf91b77931e1f0b94dd4d47'
  }

  /**
   *  Actual proposal for a given hash, if it's current.
   */
  async getAsV53(key: Uint8Array): Promise<v53.Type_105 | undefined> {
    assert(this.isV53)
    return this.ctx._chain.getStorage(this.ctx.block.hash, 'Instance1Collective', 'ProposalOf', key)
  }
   ...
   */
  get isV155() {
    return this.ctx._chain.getStorageItemTypeHash('Instance1Collective', 'ProposalOf') === '1698a2e163eda774fc7e9effa5397f8e6597a94a943d34f38afa17a689729c9d'
  }

  /**
   *  Actual proposal for a given hash, if it's current.
   */
  async getAsV155(key: Uint8Array): Promise<v155.Type_106 | undefined> {
    assert(this.isV155)
    return this.ctx._chain.getStorage(this.ctx.block.hash, 'Instance1Collective', 'ProposalOf', key)
  }
   ...
   */
  get isV159() {
    return this.ctx._chain.getStorageItemTypeHash('Instance1Collective', 'ProposalOf') === '0695bc404c3922c4fd7e6cf05f231f024b824b91c7ccfd63c86da4be37b32306'
  }

  /**
   *  Actual proposal for a given hash, if it's current.
   */
  async getAsV159(key: Uint8Array): Promise<v159.Type_105 | undefined> {
    assert(this.isV159)
    return this.ctx._chain.getStorage(this.ctx.block.hash, 'Instance1Collective', 'ProposalOf', key)
  }
   ...
   */
  get isV200() {
    return this.ctx._chain.getStorageItemTypeHash('Instance1Collective', 'ProposalOf') === '89edc09b41416965160715ea8700e9d5d57b6667c95d040389906e7931cce743'
  }

  /**
   *  Actual proposal for a given hash, if it's current.
   */
  async getAsV200(key: Uint8Array): Promise<v200.Type_103 | undefined> {
    assert(this.isV200)
    return this.ctx._chain.getStorage(this.ctx.block.hash, 'Instance1Collective', 'ProposalOf', key)
  }
   ...
   */
  get isV400() {
    return this.ctx._chain.getStorageItemTypeHash('Instance1Collective', 'ProposalOf') === 'bf7b3112a6afb03bf21afffc8233b3e0d390ec4260eb05a72bfe834516d6dcbe'
  }

  /**
   *  Actual proposal for a given hash, if it's current.
   */
  async getAsV400(key: Uint8Array): Promise<v400.Type_104 | undefined> {
    assert(this.isV400)
    return this.ctx._chain.getStorage(this.ctx.block.hash, 'Instance1Collective', 'ProposalOf', key)
  }
   ...
   */
  get isV501() {
    return this.ctx._chain.getStorageItemTypeHash('Instance1Collective', 'ProposalOf') === '0446b2b69d4000eba992dbc30c60f62bdcf45854155a1773e649b8d69cb9c41d'
  }

  /**
   *  Actual proposal for a given hash, if it's current.
   */
  async getAsV501(key: Uint8Array): Promise<v501.Type_106 | undefined> {
    assert(this.isV501)
    return this.ctx._chain.getStorage(this.ctx.block.hash, 'Instance1Collective', 'ProposalOf', key)
  }
   ...
   *  Actual proposal for a given hash, if it's current.
   */
  async getAsV600(key: Uint8Array): Promise<v600.Type_104 | undefined> {
    assert(this.isV600)
    return this.ctx._chain.getStorage(this.ctx.block.hash, 'Instance1Collective', 'ProposalOf', key)
  }
   ...
   */
  get isV701() {
    return this.ctx._chain.getStorageItemTypeHash('Instance1Collective', 'ProposalOf') === 'ee6b01382208f65f572d48f976f6aed61ffaa0ab5504b21b5063d134cdbd4153'
  }

  /**
   *  Actual proposal for a given hash, if it's current.
   */
  async getAsV701(key: Uint8Array): Promise<v701.Type_148 | undefined> {
    assert(this.isV701)
    return this.ctx._chain.getStorage(this.ctx.block.hash, 'Instance1Collective', 'ProposalOf', key)
  }
...
export class Instance2CollectiveProposalOfStorage {
   ...
   */
  get isV49() {
    return this.ctx._chain.getStorageItemTypeHash('Instance2Collective', 'ProposalOf') === 'c2200d55dc010bd1db0de89316bebc8bbe807286cce4a413847783c70617e45f'
  }
   ...
   */
  get isV53() {
    return this.ctx._chain.getStorageItemTypeHash('Instance2Collective', 'ProposalOf') === '33a59e33fccb1519e3a6069b550bff656c5271028bf91b77931e1f0b94dd4d47'
  }
   ...
   */
  get isV155() {
    return this.ctx._chain.getStorageItemTypeHash('Instance2Collective', 'ProposalOf') === '1698a2e163eda774fc7e9effa5397f8e6597a94a943d34f38afa17a689729c9d'
  }
   ...
   */
  get isV159() {
    return this.ctx._chain.getStorageItemTypeHash('Instance2Collective', 'ProposalOf') === '0695bc404c3922c4fd7e6cf05f231f024b824b91c7ccfd63c86da4be37b32306'
  }
   ...
   */
  get isV200() {
    return this.ctx._chain.getStorageItemTypeHash('Instance2Collective', 'ProposalOf') === '89edc09b41416965160715ea8700e9d5d57b6667c95d040389906e7931cce743'
  }
   ...
   */
  get isV400() {
    return this.ctx._chain.getStorageItemTypeHash('Instance2Collective', 'ProposalOf') === 'bf7b3112a6afb03bf21afffc8233b3e0d390ec4260eb05a72bfe834516d6dcbe'
  }
   ...
   */
  get isV501() {
    return this.ctx._chain.getStorageItemTypeHash('Instance2Collective', 'ProposalOf') === '0446b2b69d4000eba992dbc30c60f62bdcf45854155a1773e649b8d69cb9c41d'
  }
   ...
   */
  get isV701() {
    return this.ctx._chain.getStorageItemTypeHash('Instance2Collective', 'ProposalOf') === 'ee6b01382208f65f572d48f976f6aed61ffaa0ab5504b21b5063d134cdbd4153'
  }
...
export class TechCommitteeCollectiveProposalOfStorage {
   ...
   */
  get isV900() {
    return this.ctx._chain.getStorageItemTypeHash('TechCommitteeCollective', 'ProposalOf') === '30d56581e955e0a747e440dc53c3fb3bab066b651da862046e5832ebf1009946'
  }
   ...
   */
  get isV1001() {
    return this.ctx._chain.getStorageItemTypeHash('TechCommitteeCollective', 'ProposalOf') === '865c942056a01b1dd23fb27cb999c2ba92166cdecf033312955cc6d93d809fe3'
  }
   ...
   */
  get isV1101() {
    return this.ctx._chain.getStorageItemTypeHash('TechCommitteeCollective', 'ProposalOf') === '9f9097d7732298fa1b657f6d495d6cc0b4bb70d62f1a6c8197a0998cf2757623'
  }
...
export class TreasuryProposalsStorage {
   ...
   *  Proposals that have been made.
   */
  async getAsV49(key: number): Promise<v49.TreasuryProposal | undefined> {
    assert(this.isV49)
